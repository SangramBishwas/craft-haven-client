        ...
        <div className="lg:pl-20 navbar bg-base-content shadow-xl fixed z-50 text-white">
            ...
            <div className="navbar-end">
                <label className="swap swap-rotate px-5">
                    ...
                    <input type="checkbox" onChange={handleThemeControl} className="theme-controller" value="dark" />
                ...
                </label>
                {
                    user ?
                        <div>
                            <button onClick={handleLogout} className="lg:btn btn btn-sm">Log Out</button>
                        </div> :
                        <div>
                            <Link to="/login" className="lg:btn btn btn-sm">Login</Link>
                        </div>
                }
            </div>
            <ToastContainer />
